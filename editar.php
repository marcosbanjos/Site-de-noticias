...
<body>
    <header id="header">
        ...
        <h1><img src="img/editarNoti.jpg" alt="editar"></h1>
    </header>
    ...
    <main id="main">
        <form class="form" method="POST" action="editar_action.php">
            ...
            <div class="input-search">
                ...
                <input type="text" name="notice" id="inputNotice" value="<?= $notice['title_notice'] ?>" required>
            </div>
            <div class="input-search">
                <label for="inputDescription">Descrição da Notícia:</label>
                <textarea name="description" rows="5" id="inputDescription" required><?= $notice['description_notice'] ?></textarea>
                <div class="input-search">
